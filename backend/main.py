...
from hubspot.crm.contacts import SimplePublicObjectInputForCreate as Contact
from hubspot.crm.contacts import BatchReadInputSimplePublicObjectId as BatchRead
...
async def test():
    ...
    with open(file_name) as csv_file:
        ...
        # loop through response contacts
        leads = []
...
async def get_contacts():
    try:
        ...
        response = api_client.crm.contacts.get_all()
...
async def check_email():
    try:
        response = api_client.crm.contacts.basic_api.get_by_id(contact_id="lunawilliam@example.com", id_property="email", archived=False)
        if response:
            print("Email found")
        else:
